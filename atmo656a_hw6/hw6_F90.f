...
c         WRITE( 6,320 ) ROUT, QEXT, QABS, QBS, SCAT, asym
...
c          >>
  ...
  320 format (' ',6(F9.6+2x))
  328 FORMAT( 2X, 'ANGLE',t15, 'PHASE FTN')
  330 FORMAT( 2X, F7.2, t15,F10.5 )
